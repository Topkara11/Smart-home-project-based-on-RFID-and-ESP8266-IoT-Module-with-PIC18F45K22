/* 
1481----GÜRKAN TOPKARA PASSWORD
3526----VOLKAN KILIÇ   PASSWORD
0614----YASÝN ULUDAG   PASSWORD
*/

#define DOOR_INPUT1 PORTB.RB5
#define DOOR_INPUT2 PORTB.RB6
#define BUZZER PORTE.RE0
...
TRISB = 0X01;
UART1_Init(9600);
Keypad_Init();                     // Initialize LCD
Lcd_Init();
ADC_Init();                        // Initialize LCD
...
//--------------------------------------------------------------
void get_password()  // char idi önceden bak buna olmazsa deðiþtir.
{
...
}// Main kapatma parantezi dokunma buna.